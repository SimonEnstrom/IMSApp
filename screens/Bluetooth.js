...
class BluetoothActivity extends React.Component {
  ...
  constructor() {
    ...
    this.handleDiscoveredPeripheral = this.handleDiscoveredPeripheral.bind(
      this,
    );
    ...
    if (peripheral) {
      ...
      if (peripheral.connected) {
        BleManager.write(
          ...
          '0000ffe1-0000-1000-8000-00805f9b34fb',
          dataCharacteristic,
          [1, 0, 0, global.xCoord, global.yCoord, global.collision],
          6,
        ).then(() => {
  ...
  renderItem(item) {
    ...
    return (
      <TouchableHighlight
        onPress={() => this.handleConnectingToPeripheral(item)}>
